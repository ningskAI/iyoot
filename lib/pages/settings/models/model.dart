...
import 'package:iyoot/common/constants.dart';
import 'package:iyoot/models/common/enum_with_label.dart';
import 'package:iyoot/pages/settings/widgets/normal_item.dart';
import 'package:iyoot/pages/settings/widgets/popup_item.dart';
import 'package:iyoot/pages/settings/widgets/select_dialog.dart';
import 'package:iyoot/pages/settings/widgets/switch_item.dart';
...
SettingsModel getBanWordModel({
  ...
  String banWord = GSStorage.setting.get(key, defaultValue: '');
  return NormalModel(
          ...
          actions: [
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                GSStorage.setting.put(key, banWord);
              },
            ),
          ],
        ),
...
SettingsModel getVideoFilterSelectModel({
  ...
  int value = GSStorage.setting.get(key, defaultValue: defaultValue);
  return NormalModel(
    ...
    onTap: (context, setState) async {
      ...
      if (result != null) {
        ...
        if (result != -1) {
          ...
          GSStorage.setting.put(key, value);
        }
      }
    },
  );
