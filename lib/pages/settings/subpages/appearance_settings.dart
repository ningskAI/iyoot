...
import 'package:iyoot/widgets/settings/select_dialog.dart';
...
class AppearanceSettingsPage extends ConsumerWidget{
        ...
        child: ListView(
          ...
          children: [
            ListTile(
              ...
              onTap: () => showThemeTypeDialog(context, ref, preferences.themeMode),
            )
          ],
        ),
      ),
  ...
  Future<void> showThemeTypeDialog(BuildContext context, WidgetRef ref, ThemeMode themeMode) async{
